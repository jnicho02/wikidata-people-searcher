...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Quick and easy search for famous people on Wikidata}
  spec.description   = %q{A search that applies name and dates when searching for a famous person to give a single, accurate result}
